...
// Private-provider operational state. These tables deliberately store only
// hashes, timestamps, and normalized public tournament data. Source folder,
// workbook, sheet, and cell identifiers never enter the application database.
db.exec(`
