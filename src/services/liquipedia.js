...
import { parsePage, searchPages, searchPageUrl } from './liquipedia/client.js';
import {
  parseMatchInfo,
  parseBracketMatch,
  parseMatchlistMatch,
...
// Re-export client and parser functions so importers of this facade get the same public API.
export {
  parsePage,
  searchPages,
  searchPageUrl,
