...
const baseCopy = {
  en: {
    ...
    profile: {
      ...
      publicIdentityTitle: "Public predictor identity",
      publicIdentityDescription: "Keep your prediction identity anonymous by default, or opt in to publish your current account name and avatar.",
      publicIdentityLabel: "Show my name and avatar publicly",
      publicIdentityHelp: "This appears on the public prediction leaderboard and public MCP clients. You can turn it off at any time.",
      publicIdentityPreview: "Public leaderboard preview",
      publicIdentityEnabled: "Public",
      publicIdentityDisabled: "Anonymous",
      publicIdentityAnonymous: "Anonymous predictor",
      publicIdentityConfirmTitle: "Publish your predictor identity?",
      publicIdentityConfirmDescription: "Your current account display name and avatar will be visible on public prediction leaderboards and public MCP clients. You can revoke this immediately in Settings.",
      publicIdentityEnable: "Publish identity",
      publicIdentityCancel: "Keep anonymous",
      roundStatus: {
        open: "Open",
