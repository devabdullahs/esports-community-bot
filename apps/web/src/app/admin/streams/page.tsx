    ...
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 px-5 py-10 sm:px-8">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Curate Twitch, Kick, YouTube, and SOOP channels. Add multiple platforms for one streamer, tag multiple games,
          and choose the default embeddable channel shown on public co-stream pages.
        </p>
      </div>
