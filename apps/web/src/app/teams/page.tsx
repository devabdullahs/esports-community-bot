...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    path: paginatedPath("/teams", locale, page),
    locale,
...
export default async function TeamsDirectoryPage({
  ...
  if (page > 1 && teams.length === 0) notFound();
    ...
    <main className="ec-public-page mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-4 py-8 sm:px-8 sm:py-10">
      ...
      <section className="ec-profile-heading">
        <div className="flex flex-col gap-4">
          ...
          <form method="get" action={localizedPath("/teams", locale)} className="flex max-w-md flex-wrap items-end gap-2">
