...
describe("admin navigation model", () => {
  ...
  test("scoped admins never see super-only entries but keep MCP keys", () => {
    ...
    for (const href of ["/admin/analytics", "/admin/predictions", "/admin/users", "/admin/partners", "/admin/streams", "/admin/source-health", "/admin/tournaments", "/admin/team", "/admin/audit"]) {
